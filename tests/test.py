...
class TestGetSimulation(unittest.TestCase):
    ...
    def test_database_IDS(self):
        # Open the file:
        print(crumbs.get_simulations_rowids("tests/data/out.db", "quetzal_EGG_1", failed=False))
        print(crumbs.get_simulations_rowids("tests/data/out.db", "quetzal_EGG_1", failed=True))
